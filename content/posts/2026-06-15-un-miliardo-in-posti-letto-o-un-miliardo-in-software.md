---
title: "Un miliardo in posti letto, o un miliardo in software?"
date: 2026-06-15
summary: "Tolta la raffineria, la cosa che la Sardegna vende di più al mondo è la vacanza di un turista straniero: il nostro export più forte e, allo stesso tempo, il nostro settore meno produttivo. Sul primo punto sono d'accordo. Il secondo vorrei superarlo."
tags: ["politics", "opinion", "europe", "sardinia", "economics"]
draft: false
cover:
  image: "images/cover-a-billion-in-beds.png"
  alt: "Un miliardo in posti letto, o un miliardo in software?"
  relative: false
---
...
Nel 2024, secondo i dati della Banca d'Italia, i visitatori stranieri hanno speso in Sardegna circa 1,85 miliardi di euro. 
Per capire di cosa parliamo, confrontiamo questa cifra con quello che spediamo davvero nei container (sempre escludendo il petrolio): l'agroalimentare vale circa 250 milioni, i metalli 230, i prodotti chimici meno di 200, il vino una frazione di tutto questo. 
Se sommiamo ogni altra voce, seguendo i dati del CRENoS, l'intero export sardo non petrolifero non arriva a 1,2 miliardi. Significa che il turismo straniero, da solo, pesa più di tutto il resto messo insieme. 
Certo, paragonare la spesa dei turisti al valore delle merci in dogana non è un confronto metodologicamente perfetto (la spesa lorda non è valore aggiunto netto). 
Ma lo faccio lo stesso. In entrambi i casi, è la Sardegna che vende qualcosa al resto del mondo, e una di queste voci vale più di tutte le altre sommate. È il nostro export principale, e arriva ogni estate in euro, via aereo o traghetto.
...
1. Banca d'Italia, statistiche sulla spesa del turismo straniero (turismo internazionale, bilancia dei pagamenti) - [bancaditalia.it](https://www.bancaditalia.it/statistiche/tematiche/rapporti-estero/turismo-internazionale/index.html); dato Sardegna 2024 di ~1,85 miliardi di euro via stampa regionale
2. ISTAT, ["Conto satellite del turismo per l'Italia - Anno 2023"](https://www.istat.it/it/archivio/turismo) - produttività del lavoro 99.015 euro (−30% sul nazionale), reddito pro capite 17.709 euro (−35%)
3. Valore aggiunto per addetto nella ricettività italiana (~44.000 euro contro ~82.000 dei concorrenti), Ministero delle Imprese e del Made in Italy, via [partitaiva.it](https://www.partitaiva.it/editoriali/turismo-italia-2026-record-pil/)
4. Mario Holzner, ["Tourism and Economic Development: The Beach Disease?"](https://www.sciencedirect.com/science/article/abs/pii/S0261517710001652) - Tourism Management, 2011; e Chao et al., modello della malattia olandese del turismo, 2006
5. R. Bronzini, E. Ciani, F. Montaruli, ["Tourism and local growth in Italy"](https://www.tandfonline.com/doi/abs/10.1080/00343404.2021.1910649) - Regional Studies, vol. 56, n. 1 (2022), pp. 140-154; in origine Banca d'Italia QEF n. 509 (2019)
6. CRENoS, 32° Rapporto sull'economia della Sardegna (2025) - microimprese oltre il 96%, 2,9 addetti in media, le micro assorbono oltre il 60% degli occupati contro il 38% del Centro-Nord - [crenos.unica.it](https://crenos.unica.it/)
7. R&S 182 euro pro capite contro 439 (Italia) e 742 (UE), PIL pro capite 29.504 contro 40.898 dollari, emigrazione dei laureati - CRENoS / OCSE 2025, via [Cagliari Today](https://www.cagliaritoday.it/economia/economia-sardegna-ocse-2025-sottosviluppo-.html)
8. Svimez, Rapporto 2025 - Sardegna +0,9% nel 2024 trainata da industria e costruzioni, servizi in calo, ~10.000 persone tra i 25 e i 34 anni emigrate - [svimez.it](https://www.svimez.it/rapporto-svimez-2025/) e [Cagliari Today](https://www.cagliaritoday.it/economia/economia-sardegna-rapporto-svimez-2025.html)
9. Storia di CRS4, Video On Line e Tiscali - le origini sarde dell'Internet italiano, via [ANSA](https://www.ansa.it/sardegna/notizie/2022/05/19/la-sardegna-patria-per-start-up-una-storia-lunga-40-anni_f4599fe4-8be4-46ca-b8d2-8b0b7a228e02.html) e fonti pubbliche
10. The Net Value ([thenetvalue.com](https://thenetvalue.com/incubatore/)), Abinsula ([abinsula.com](https://abinsula.com/)) e l'acceleratore [Frontech](https://www.cdpventurecapital.it/cdp-venture-capital/en/dettaglio_acceleratore.page?contentId=ACL3494) di CDP Venture Capital a Cagliari

***

_**Nota di metodo:** Questo pezzo nasce da un'analisi sull'economia della Sardegna che sta girando in questi giorni, e ho voluto ragionare con la mia testa invece di limitarmi a reagire. L'ho scritto con l'aiuto dell'IA (Claude Code e Gemini) e ho verificato ogni cifra sulle fonti aggiornate: è così che mi sono accorto, per esempio, che i numeri di produttività dell'ISTAT sono dati nazionali del settore turistico, non sardi, e li ho riportati onestamente qui sopra. Lo spiazzamento di cui parlo è un'ipotesi plausibile, non un fatto dimostrato, e l'ho scritto. L'opinione, nel bene e nel male, è mia. Se trovate un numero sbagliato, scrivetemelo e lo correggo._
