...
### An adjacent finding from a different population[#](#an-adjacent-finding-from-a-different-population)

A 2025 systematic review I came across after writing this post is worth flagging because it sits next to the walking literature without quite overlapping it.

Ge and colleagues, in *Frontiers in Public Health*, ran a Bayesian model-based network meta-analysis of 15 RCTs (1,196 participants) on exercise interventions for cognitive function in adults with major depressive disorder. They report a non-linear dose-response, with a minimum effective dose around 967 METs-minutes per week (inside the WHO-recommended range), and a ranking by exercise type that puts Tai Chi/Qigong first, mixed aerobic and resistance training next, and walking/jogging in the middle of the pack. Their MCID is 0.5 SD, the standard threshold for clinically meaningful change in MoCA-style assessments.

It does not unsettle the walking finding for the use case I described. Their outcome is general cognitive function measured in a depressed sample; mine is divergent-thinking ideation in healthy knowledge workers, a much narrower slice. The Phase 1 free-walking effect Oppezzo and Murali document is a specific intervention for a specific cognitive mode, and the Ge paper does not measure that mode at all. What it does suggest is that if your outcome of interest is general cognitive recovery, especially in clinical populations or older adults, the evidence currently points more strongly toward mind-body practices than toward unstructured walking. That's a different question than the one the morning routine answers, but worth knowing the answer to.

The usual caveat: 15 trials, mostly small, single-population (MDD), with moderation effects suggesting younger and more-female samples respond more strongly. Replication in non-clinical adults is the missing piece.
...
* Ge, J., Wang, Q., Wang, S., Xiong, X., & Zhai, Y. (2025). Optimal dose and type of exercise to improve cognitive function in adults with major depressive disorder: A systematic review and Bayesian model-based network meta-analysis. *Frontiers in Public Health*, 13, 1662778. [Open access](https://doi.org/10.3389/fpubh.2025.1662778)
