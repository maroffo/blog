...
After writing this post I came across a 2025 systematic review that sits next to the walking literature without quite overlapping it.

Ge and colleagues, in *Frontiers in Public Health*, ran a Bayesian model-based network meta-analysis of 15 RCTs (1,196 participants) on exercise interventions for cognitive function in adults with major depressive disorder. They report a non-linear dose-response, with a minimum effective dose around 967 METs-minutes per week (inside the WHO-recommended range), and a ranking by exercise type that puts Tai Chi/Qigong first, mixed aerobic and resistance training next, and walking/jogging third. Their MCID is 0.5 SD, the standard threshold for clinically meaningful change in MoCA-style assessments.

This doesn't unsettle the walking finding for the use case I described. Their outcome is general cognitive function measured in a depressed sample; mine is divergent-thinking ideation in healthy knowledge workers, a much narrower slice. The Phase 1 free-walking effect Oppezzo and Murali document is a specific intervention for a specific cognitive mode, and the Ge paper does not measure that mode at all. It suggests something different: if your outcome is general cognitive recovery, especially in clinical populations or older adults, the evidence points more strongly toward mind-body practices than toward unstructured walking. That's a different question than the one the morning routine answers, but worth knowing the answer to.

Caveats: 15 trials, mostly small, single-population (MDD), with moderation effects suggesting younger samples and samples with more female participants respond more strongly. Replication in non-clinical adults is what's still missing.
